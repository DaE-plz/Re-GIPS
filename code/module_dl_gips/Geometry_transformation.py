...
class GeometryTransformation(nn.Module):
    def __init__(self, channels, image_size, proj_size,
        ...
        self.ap_ap=code.different_task.task1.AP_AP_Operators(self.image_size, self.proj_size, self.num_proj_ap, self.start_angle_ap, self.end_angle_ap)
        self.ap_aplt=code.different_task.task1.AP_APLT_Operators(self.image_size, self.proj_size, self.num_proj_aplt, self.start_angle_aplt, self.end_angle_aplt)
