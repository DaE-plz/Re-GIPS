...
import code.forward_backward.ct_geometry_projector
...
class AP_AP_Operators():
    def __init__(self, image_size, proj_size, num_proj, start_angle, end_angle):
        ...
        geo_param = code.forward_backward.ct_geometry_projector.Initialization_ConeBeam(image_size=self.image_size,
        ...
        self.forward_projector = code.forward_backward.ct_geometry_projector.Projection_ConeBeam(geo_param)
        self.backward_projector = code.forward_backward.ct_geometry_projector.FBP_ConeBeam(geo_param)
